...
public class RequestParentBookMark {
    private final BookmarkViewModel bookmarkViewModel;
    private final MainParentActivity mainActivity;

    public RequestParentBookMark(MainParentActivity mainActivity, BookmarkViewModel bookmarkViewModel) {
